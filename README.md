...
> **AUMOVIO STAR IT Specialist Internship 포트폴리오 프로젝트**
> RPA(Robotic Process Automation) + AX(AI Transformation) + BI 디지털화를 한 번에 구현.
...
- **🔗 실제 시스템 연동**: ServiceNow / Jira / Slack API 연동
- **🧠 RAG 적용**: 사내 위키를 벡터 DB에 임베딩해 답변 정확도 향상
- **📈 SLA 모니터링**: 응답 시간 임계치 초과 시 자동 알림
- **🌐 다국어 지원**: 글로벌 IT팀 대응
- **🤖 슬랙봇 변환**: Streamlit UI → 슬랙 슬래시 커맨드/봇
